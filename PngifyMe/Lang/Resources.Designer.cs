...
namespace PngifyMe.Lang {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Enable Web Output (OBS Browser Source).
        /// </summary>
        public static string EnableWebOutput {
            get {
                return ResourceManager.GetString("EnableWebOutput", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to In OBS: Browser Source → http://localhost:7667/.
        /// </summary>
        public static string WebOutputOBSHint {
            get {
                return ResourceManager.GetString("WebOutputOBSHint", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Web output background (chroma key, e.g. #00FF00 green).
        /// </summary>
        public static string WebOutputBackgroundColor {
            get {
                return ResourceManager.GetString("WebOutputBackgroundColor", resourceCulture);
            }
        }
