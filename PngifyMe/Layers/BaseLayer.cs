...
public abstract class BaseLayer
{
    ...
    public BaseLayer Clone(Layersetting adder)
    {
        AddedBy = adder;
    ...
    /// <summary>
    /// call this when readding the same instance, can be inherited to override properties of child layers
    /// </summary>
    public virtual void Reset()
    {
        CurrentTime = 0;
        CurrentExitingTime = 0;
        GlobalTime = 0;
        Entered = false;
        IsExiting = false;
    }
